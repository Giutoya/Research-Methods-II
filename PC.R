...
#Created by Marco Veronese Passarella on 30 May 2019, Modified By GTY for ECON 530 2026 
...
b_s=matrix(data=b_cb+b_h,nrow=nScenarios,ncol=nPeriods) 
#Consumption goods
...
#Households wealth
v=matrix(data=b_h+h_h,nrow=nScenarios,ncol=nPeriods) 
#Income = GDP
